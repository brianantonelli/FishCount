...
- (id)initWithModel:(id)aModel 
{
	if (self = [super initWithModel:aModel]) {
        ...
        [section addFormField:[[[IBAReadOnlyTextFormField alloc] initWithKeyPath:@"theatre" title:@"Theatre"] autorelease]];
        [section addFormField:[[[IBAReadOnlyTextFormField alloc] initWithKeyPath:@"lunch" title:@"Lunch"] autorelease]];
        [section addFormField:[[[IBAReadOnlyTextFormField alloc] initWithKeyPath:@"dolphin" title:@"Dolphin"] autorelease]];
